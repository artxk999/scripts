...
CMDs = {}
-- custom
CMDs[#CMDs + 1] = {NAME = 'shield (CLIENT)', DESC = 'Shield from chartreuse cannon'}
-- custom
...
CMDs[#CMDs + 1] = {NAME = 'loopbring / lb [player] [distance] [delay] (CLIENT)', DESC = 'Loop brings a player to you (useful for killing)'}
CMDs[#CMDs + 1] = {NAME = 'unloopbring / ulb [player]', DESC = 'Undoes loopbring'}
...
addcmd('shield',{},function(args, speaker)
...
addcmd('twlg',{},function(args, speaker)
	task.wait(1)
end)

addcmd('twmd',{},function(args, speaker)
	task.wait(0.5)
end)

addcmd('twsm',{},function(args, speaker)
	task.wait(0.2)
end)
...
local bringT = {}
addcmd('loopbring',{"lb"},function(args, speaker)
	local players = getPlayer(args[1], speaker)
	for i,v in pairs(players)do
		task.spawn(function()
...
addcmd('unloopbring',{'noloopbring','ulb'},function(args, speaker)
	local players = getPlayer(args[1], speaker)
	for i,v in pairs(players)do
		task.spawn(function()
...
addcmd('hitbox',{'h'},function(args, speaker)
	local players = getPlayer(args[1], speaker)
